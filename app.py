...
ktp_database = {
    ...
    "7 класс": {
        ...
        "Геометрия": {
            "Раздел 1. Начальные геометрические сведения": [
                ...
                "7.1.2.1 - знать and применять аксиомы расположения точек на прямой и на плоскости (аксиома порядка);",
    ...
    "8 класс": {
        "Алгебра": {
            ...
            "Раздел 3. Квадратичная функция": [
                ...
                "8.4.1.3 - знать свойства and строить график квадратичной функции вида y = ax^2 + bx + c, a != 0;",
                "8.4.1.4 - находить значения функции по заданным значениям аргумента и находить значение аргумента по заданным значениям функции;",
    ...
    "9 класс": {
        ...
        "Геометрия": {
            ...
            "Раздел 4. Окружность. Многоугольники": [
                ...
                "9.1.1.4 - знать and применять теоремы о пропорциональности отрезков в круге;",
    ...
    "10 класс (ЕМН)": {
        "Алгебра и начала анализа": {
            "Раздел 1. Функции, их свойства и графики. Многочлены": [
                ...
                "10.2.1.4 - находить старший коэффициент, степень and свободный член многочлена с одной переменной;",
    ...
    "10 класс (ОГН)": {
        "Алгебра и начала анализа": {
            "Раздел 1. Funktion, ее свойства и график. Тригонометрические функции": [
    ...
    "11 класс (ЕМН)": {
        "Алгебра и начала анализа": {
            ...
            "Раздел 2. Степени, корни и степенная функция. Иррациональные уравнения": [
                ...
                "11.4.1.12 - Знать and применять правила нахождения производной степенной функции с действительным показателем;",
...
def generate_perfect_math(selected_class, subject, section, objectives_list, w_type, var_qty, t_count, score):
    ...
    prompt = f"""
    Ты — опытный учитель математики, составитель методических материалов для школ Казахстана. 
...
st.markdown(
    ...
    /* Иконки к заголовкам разделов внутри карточки */
    .spec-block::before {
        content: "💡 ";
        font-size: 13pt;
    }
    ...
    .tasks-list {
        ...
        margin-top: 15px;
        margin-bottom: 25px;
        list-style-type: none; /* Убираем стандартные цифры, делаем свои крупные */
    ...
    /* Таблица критериев (Галочки и четкая структура) */
    table { 
        width: 100%; 
    ...
    /* Блок ответов и ключей для учителя (Оранжевый цвет + Книга) */
    .answers-block {
    ...
    @media print {
        /* Скрываем весь интерфейс сайта Streamlit */
        ...
        /* Превращаем карточки в строгие печатные листы */
        .vzaimo-card { 
            ...
            page-break-after: always !important; /* Каждый вариант строго на новом листе А4 */
        }
        
        /* Убираем цветной фон для экономии краски, оставляем только строгие черные рамки */
        .spec-block {
        ...
        .answers-block {
            ...
            color: #000000 !important;
            padding: 10px 0px !important;
            page-break-inside: avoid !important; /* Ключи не разрываются посередине страницы */
        }
        ...
        /* Убираем эмодзи при печати, чтобы бланки оставались строго академическими */
        .tasks-list li::before {
