    ...
    "5 класс": {
        "Математика": {
            ...
            "Раздел 3. Делимость натуральных чисел": [
                ...
                "5.1.2.6 - применять признаки делимости натуральных чисел на 3 and 9;",
    ...
    "10 класс (ЕМН)": {
        "Алгебра и начала анализа": {
            ...
            "Раздел 3. Теория вероятностей и математическая статистика": [
                ...
                "10.3.2.15 - решать задачи с использованием числовых характеристики дискретных случайных величин;",
...
# =====================================================================
# РАЗДЕЛ 3. ФУНКЦИЯ ВЗАИМОДЕЙСТВИЯ С ИИ (ПРЯМОЙ СТАБИЛЬНЫЙ ВЫЗОВ)
# =====================================================================
import g4f
from g4f.Provider import Blackbox # Явный импорт стабильного провайдера
...
def generate_perfect_math(selected_class, subject, section, objectives_list, w_type, var_qty, t_count, score):
    ...
    # Прямой вызов без использования g4f.client или g4f.local
...
st.markdown(
    ...
    /* Настройка боковой панели (сайдбара) */
    [data-testid="stSidebar"] {
        background-color: #f8fafc !important;
        border-right: 3px solid #3b82f6 !important;
    }
    
    /* Настройка всех селекторов в боковой панели */
    ...
    /* Основной фон главного экрана */
    .main {
        background-color: #f1f5f9 !important;
    }
    
    /* Крупный заголовок сайта */
    h1 {
        color: #1e3a8a !important;
    ...
    /* Школьный список задач (Карандаш ✏️) */
    .tasks-list {
        padding-left: 25px;
        margin-top: 15px;
        margin-bottom: 25px;
