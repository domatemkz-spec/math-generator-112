...
# =====================================================================
# РАЗДЕЛ 3. ФУНКЦИЯ ВЗАИМОДЕЙСТВИЯ С ИИ (БЕСПЛАТНЫЙ ОТКРЫТЫЙ ИНТЕРФЕЙС)
# =====================================================================
def generate_perfect_math(selected_class, subject, section, objectives_list, w_type, var_qty, t_count, score):
    ...
    # Используем публичный, стабильный и полностью бесплатный шлюз без авторизации (DuckDuckGo AI шлюз)
    url = "https://text.pollinations.ai/"
    payload = {
        "messages": [{"role": "user", "content": prompt}],
        "model": "openai", # Автоматически подбирает быструю GPT-модель
        "private": True
    }
    ...
    if response.status_code == 200:
        ...
        # Резервный простой текстовый метод на случай сбоя JSON-пакета
        alt_response = requests.get(f"https://text.pollinations.ai/{requests.utils.quote(prompt)}")
